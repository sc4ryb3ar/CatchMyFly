package com.Sc4ryb3ar.catchmyfly.listeners;
 ...
 * @author ITCuties
 */
public class ListListeners implements OnItemClickListener {
    ...
    public ListListeners(List<RssItem> aListItems, Activity anActivity) {
